...
$(function () {
    $('#adminUsersListDT').dataTable({
		...
		"order":[[6,"desc"]],
          "columnDefs": [
            {"name": "users.id", 'aTargets': [0], 'bSortable': false, "orderable": false},
            {"name": "profile.fname", "targets": [1]},
            {"name": "users.email", "targets": [2]},
            {"name": "profile_country", 'targets': [3]},
            {"name": "cards_total_count", "targets": [4]},
            {"name": "accounts_us_count", "targets": [5]},
...
//        ],
    ...
    var table = $('#adminUsersListDT').DataTable();
