...
<table style = 'background-color:#fff;text-align:center;border:solid 1px #000'>
    ...
    <tr><td>
            ...
            <table style = 'width:100%;background-color:#fff;text-align:left;'><tr><td style = 'text-align:center' colspan = '2'>
                ...
                <tr><td colspan = '2'>				
                        Congratulations, you have successfully change the email address with {{ getSiteName() }}.
                        You just need to click on the verify email button below to verify your email account with us.
                        <br />
                        <br />
                    </td>
                </tr>
                <tr><td colspan = '2' style = 'text-align:center;'>
                        <a href="{{url('/confirm/'.$data->confirmation_code)}}" style = 'background-color:#0762b9;color:#fff;padding: 10px 20px;text-decoration:none; font-size:1.2em;'>Verify Email</a>
                        <br />
                        <br />
                    </td>
                </tr>
                <tr><td colspan = '2'>
                        ...
                        <br />
                        <br />
                       {{url('/confirm/'.$data->confirmation_code)}}
                        <br />
                        <br />
                    </td></tr>
                <tr><td colspan = '2'>
                ...
                <tr><td colspan='2' style='padding:5px 0px 5px 5px;'>Copyright &copy; 2016 {{ getSiteName() }}. All rights reserved.</tr>
                </td></tr>
            </table>
        </td></tr>
</table>
