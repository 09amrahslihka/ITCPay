            ...
            <div class="col-md-12">
				<div class="change-form-bg clearfix">
					<div class="message-info clearfix">
						<h3 class="box-title">Change call us status</h3>
					</div>
					...
					@endif
					<form method="post" action="{{URL::to('/admin/update-callus')}}">
						<div class="row">
							<div class="email-form clearfix">
								<div class="col-md-4">
									<div class="form-group has-feedback">
										<label for="callusEnabled">Call Us Enabled:</label>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="email-btn clearfix">
									...
									<input type="submit" value="Change Call Us Settings" class="next btn btn-primary">
								</div>
							</div>
						</div>
					</form>
