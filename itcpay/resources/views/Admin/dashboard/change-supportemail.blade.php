            ...
            <div class="col-md-12">
				<div class="change-form-bg clearfix">
					<div class="message-info clearfix">
						<h3 class="box-title">Change Support Email Address</h3>
					</div>
					...
					@endif
					<form method="post" action="{{URL::to('/admin/update-supportemail')}}">
						<div class="row">
							<div class="email-form clearfix">
								<div class="col-md-4">
									<div class="form-group has-feedback">
										<label for="callusEnabled">Support Email :</label>
										<!-- <input type="checkbox" id="callusEnabled" value="1" title="" name="callusEnabled" @if ($callusEnabled) checked @endif> -->

										<input type="text" id="callusEnabled" value="{{isSupportemail()}}" title="" name="supportEmail" required>
									</div>
								</div>
							</div>
						</div>	
						...
						<div class="row">
							<div class="col-md-12">
								<div class="email-btn clearfix">
									...
									<input type="submit" value="Change Support Email" class="next btn btn-primary">
								</div>
							</div>
						</div>
					</form>
            ...
            rules:
                {
		         ...
		         messages: { 
		             supportEmail:{ required: 'This field is required', email: 'Please enter a valid email address'}		   
