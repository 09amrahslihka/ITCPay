            ...
            <div class="col-md-12">
				<div class="change-form-bg clearfix">
					<div class="message-info clearfix">
						<h3 class="box-title">Change Support Ticket status</h3>
					</div>
					...
					@endif
					<form method="post" action="{{URL::to('/admin/update-supportticket')}}">
						<div class="row">
							<div class="email-form clearfix">
								<div class="col-md-4">
									<div class="form-group has-feedback">
										<label for="callusEnabled">Support Ticket Enabled:</label>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="email-btn clearfix">
									...
									<input type="submit" value="Change Support Ticket Settings" class="next btn btn-primary">
								</div>
							</div>
						</div>
					</form>
