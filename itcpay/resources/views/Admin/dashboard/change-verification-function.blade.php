            ...
            <div class="col-md-12">
				<div class="change-form-bg clearfix">
					<div class="message-info clearfix">
						<h3 class="box-title">Verification function settings</h3>
					</div>
					...
					@endif
					<form method="post" action="{{URL::to('/admin/update-verification-function')}}">
						<div class="row">
							<div class="email-form clearfix">
								<div class="col-md-4">
									<div class="form-group has-feedback">
										<label for="callusEnabled">Account verification Enabled:</label>
										<input type="checkbox" id="callusEnabled" value="1" title="" name="verificationFunction" @if ($callusEnabled) checked @endif>
									</div>
								</div>
							</div>
						</div>	
						...
						<div class="row">
							<div class="col-md-12">
								<div class="email-btn clearfix">
									...
									<input type="submit" value="Change Account Verification Settings" class="next btn btn-primary">
								</div>
							</div>
						</div>
					</form>
