...
@section('content')
    ...
    <script>
        var loadDataSet = "{{ route('admin_selected_users_dataset') }}";
        var deleteUserAccountURL = "{{ route('admin_users_delete_user_account') }}";
        var deleteUserAccountSuccessRedirectURL = "{{ route('admin_users_delete_selected_user_account_success_redirect') }}";
        var _token = "{{csrf_token()}}";
    </script>
    <script src="{{ asset("js/admin_selected_users_list.js") }}"></script>
        ...
        <div class="col-sm-12">
            <div class="change-form-bg clearfix">
                ...
                <div class = "message-info clearfix">
                    <h3 class = "box-title">Selected accounts</h3>
                </div>
                <div class="row">
                            ...
                            <div class="row">
                                <div class="section-search clearfix">
                                    ...
                                    <span class="pull-right">
                                        Search: <input class="info-personal" type="text" name="globalSearchTxt" id="globalSearchTxt"  maxlength="100" placeholder="Name, Email and Created Date"/>
                                    </span>
                                </div>
                            </div>
                        </div>
