...
@section('content')
    ...
    var deleteUserAccountSuccessRedirectURLSingle = "{{ route('admin_users_delete_user_account_success_redirect') }}";
        ...
        function ChangeAccountStatus(c, i)
        {
            alert(i);
    ...
    <style>
     ...
     <script>
        var loadDataSet = "{{ route('admin_identity_verification_request') }}";
    ...
    <script src="{{ asset("js/admin_identityVerification_list.js") }}"></script>
        ...
        <div class="col-sm-12">
            <div class="change-form-bg clearfix">
                ...
                <div class = "message-info clearfix">
                    <h3 class = "box-title">Identity Verification Request</h3>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="table-scroll">
                            <table id="adminIdentityListDT" class="table table-striped table-bordered table-vcenter">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Information and documents</th>
                                        <th>Creation date</th>
                                        <!-- <th>Action</th> -->
                                    </tr>
                                </thead>
