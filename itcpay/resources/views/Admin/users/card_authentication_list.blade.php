...
@section('content')
    ...
    <style>
     ...
     <script>
        var loadDataSet = "{{ route('admin_card_authentication_request') }}";
    ...
    <script src="{{ asset("js/admin_cardAuthentication_list .js") }}"></script>
        ...
        <div class="col-sm-12">
            <div class="change-form-bg clearfix">
                ...
                <div class = "message-info clearfix">
                    <h3 class = "box-title">Card Authetication Requests</h3>
                </div>
                <div class="row">
