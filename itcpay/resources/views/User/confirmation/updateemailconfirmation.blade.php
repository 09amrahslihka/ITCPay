...
<html>
<head>
    <title>Change Email Address Confirmation - <?php echo getSiteName(); ?></title>
...
<div class="content-wrap">
    <div class="content-overlay">
        ...
        <div class="content col-sm-6 col-sm-offset-3 col-xs-12" style="margin-left: 25%;">
            ...
            <div class="btn-conf">
                <a href="{{URL::to('/register/resend-change-email')}}/{{$email}}">Resend Verification Email<i class="fa fa-sign-in"></i></a>
            </div>
            <div class="btn-conf">
