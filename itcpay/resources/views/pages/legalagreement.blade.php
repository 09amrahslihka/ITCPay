            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-sub-section-content about_us_content">
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">1. Eligibility</p>
                            <ol>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">2.) Required Information:</p>
                            <p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">3.) Payments:</p>
                            <p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">4.) Money in user accounts:</p>
                            <p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">5.) Money withdrawal:</p>
                            <p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">6.) Deactivation/Account closure –</p>
                            <p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">7.) {{ getSiteName() }} Buyer Protection:</p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">{{ getSiteName() }} buyer protection eligibility</p>
                            <ul>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">8.) {{ getSiteName() }} seller protection:</p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">Eligibility</p>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">Items not eligible for Seller protection</p>
                            <ul>
                        ...
                        <div class="text-inner-cms">
                            <p class="about-inner-head">9.) Restrictions we impose on both Buyers and Sellers:</p>
